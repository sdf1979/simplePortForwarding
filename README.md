...
Создавалось для перенаправления RDP-соединений. Управляющий порт, которое слушает приложение 80, задаётся в файле config.json.
...
# Подключение к RDP нужного сервера с помощью файла bat
